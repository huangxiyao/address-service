...
IFS="${TAB}" read deploymentIdentifier displayName time companyCode environmentCode playbookVersion platformVersion userName success <<< "$(database.sh latestCompanyEnvironmentDeployment ${companyCode} ${environmentCode})"
