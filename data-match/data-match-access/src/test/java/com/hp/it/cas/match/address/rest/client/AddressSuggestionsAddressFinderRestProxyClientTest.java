 ...
 * AddressSuggestionsAddressFinderRestProxyClient
 * 
 * @see {@link com.hp.it.cas.match.address.rest.client.AddressSuggestionsAddressFinderRestProxyClient}
 * @version 1.0
 * @author Hu, Fei-Yang (Edward, HPIT-DS-CDC)
 * 
 */
public class AddressSuggestionsAddressFinderRestProxyClientTest {
	...
	public void testExecute() {
		...
		Assert.assertTrue(AddressSuggestionsAddressFinderRestProxyClient.compareExpectedWithActual(AddressQueryResultSuitID));
	}
