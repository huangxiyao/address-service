	...
	private void populateResultData(List<Object> jsonList, AddressQueryResult result) {
		for (Object jsonResult : jsonList) {
			if (jsonResult instanceof Map) {
				...
				addressData.setGeoCodingStatus((String) jsonResultMap.get("geoCodingStatus"));
				addressData.setSupplementaryATStatus((String) jsonResultMap.get("supplementaryATStatus"));
				addressData.setSupplementaryBRStatus((String) jsonResultMap.get("supplementaryBRStatus"));
				addressData.setSupplementaryCHStatus((String) jsonResultMap.get("supplementaryCHStatus"));
				addressData.setSupplementaryDEStatus((String) jsonResultMap.get("supplementaryDEStatus"));
				addressData.setSupplementaryFRStatus((String) jsonResultMap.get("supplementaryFRStatus"));
				addressData.setSupplementaryJPStatus((String) jsonResultMap.get("supplementaryJPStatus"));
				addressData.setSupplementaryPLStatus((String) jsonResultMap.get("supplementaryPLStatus"));
				addressData.setSupplementaryRSStatus((String) jsonResultMap.get("supplementaryRSStatus"));
				addressData.setSupplementaryZAStatus((String) jsonResultMap.get("supplementaryZAStatus"));
				...
				populateAddressElement((List<Object>) jsonResultMap.get("subProvince"), addressData.getSubProvinces());
				...
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryGB"), addressData.getSupplementaryGb());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryUS"), addressData.getSupplementaryUs());
				populateAddressElement((List<Object>) jsonResultMap.get("geoCoding"), addressData.getGeoCoding());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryAT"), addressData.getSupplementaryAt());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryBR"), addressData.getSupplementaryBr());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryCH"), addressData.getSupplementaryCh());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryDE"), addressData.getSupplementaryDe());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryFR"), addressData.getSupplementaryFr());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryJP"), addressData.getSupplementaryJp());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryPL"), addressData.getSupplementaryPl());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryRS"), addressData.getSupplementaryRs());
				populateAddressElement((List<Object>) jsonResultMap.get("supplementaryZA"), addressData.getSupplementaryZa());
				populateAddressElement((List<Object>) jsonResultMap.get("cass"), addressData.getCass());
