...
public class MailHelper {
	 ...
	 * </p>
	 * 
	 * <li>the mail address: data.put(MailHelper.EMAIL_TO, "");</li> <li>the
	 * mail cc address(optional): data.put(MailHelper.EMAIL_CC, "");</li> <li>the
	 * mail bcc address(optional): data.put(MailHelper.EMAIL_BCC, "");</li> <li>
	 * the mail subject: data.put(MailHelper.EMAIL_SUBJECT, "");</li> <li>the
	 * mail content: data.put(MailHelper.EMAIL_TEXT, "");</li> <li>the mail
	 * attachment(optional): data.put(MailHelper.EMAIL_ATTACHMENT, "");</li>
	 * 
	 * <p><br>
	...
	private static void setAttachment(String attachment, MimeMultipart mmp) throws MessagingException,
