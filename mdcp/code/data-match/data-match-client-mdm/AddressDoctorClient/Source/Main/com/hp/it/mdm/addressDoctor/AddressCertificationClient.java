...
public class AddressCertificationClient extends AddressDoctorClient {

    public static final Logger log = Logger.getLogger(AddressCertificationClient.class);

    // list of function names
    protected static String fName = "Address Certification";
    ...
    public AddressCertificationClient(TypedProps props) {

        setFunctionText();
    }

    /* create a new client by duplicating an existing one */
    public AddressCertificationClient(AddressCertificationClient client) {
    ...
    public void cleanse(Map context, Map input, Map output) {
        ...
        if (!allGood)
            return;
        String server_url = cleanseProps.getProperty("CertifiedAddressFinderRestProxy_URL");
        CertifiedAddressFinderRestProxy proxy = new CertifiedAddressFinderRestProxy(server_url);
        /* get map inputs */
    ...
    public Object clone() {
        return new AddressCertificationClient(this);
    }
