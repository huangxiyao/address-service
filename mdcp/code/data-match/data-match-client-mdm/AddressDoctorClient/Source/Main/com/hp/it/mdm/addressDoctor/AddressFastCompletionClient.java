...
public class AddressFastCompletionClient extends AddressDoctorClient {

    public static final Logger log = Logger.getLogger(AddressFastCompletionClient.class);

    // list of function names
    protected static String fName = "Address Fast Completion";
    ...
    public AddressFastCompletionClient(TypedProps props) {

        setFunctionText();
    }

    /* create a new client by duplicating an existing one */
    public AddressFastCompletionClient(AddressFastCompletionClient client) {
    ...
    public Object clone() {
        return new AddressFastCompletionClient(this);
    }
