...
public class AddressLooseValidationClient extends AddressDoctorClient {

    public static final Logger log = Logger.getLogger(AddressLooseValidationClient.class);

    // list of function names
    protected static String fName = "Address Loose Validation";

    protected static String fDesc = "Address Loose Validation Function";

    String configFile = "resources/addressDoctor.properties";
    ...
    public AddressLooseValidationClient(TypedProps props) {

        setFunctionText();
    }

    /* create a new client by duplicating an existing one */
    public AddressLooseValidationClient(AddressLooseValidationClient client) {
    ...
    private void loadProps() {
        try {
            InputStream fi = this.getClass().getClassLoader().getResourceAsStream(configFile);
    ...
    public void cleanse(Map context, Map input, Map output) {
        ...
        if (!allGood)
            return;
        String server_url = cleanseProps.getProperty("LooselyValidatedAddressFinderRestProxy_URL");
        LooselyValidatedAddressFinderRestProxy proxy = new LooselyValidatedAddressFinderRestProxy(server_url);
        /* get map inputs */
    ...
    public Object clone() {
        return new AddressLooseValidationClient(this);
    }

    public void disconnect() {
        /*
         * Any things that need to be done to free up any resources need to be done here
         */
    }
