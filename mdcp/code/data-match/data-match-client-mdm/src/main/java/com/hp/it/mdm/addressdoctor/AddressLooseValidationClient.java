...
public class AddressLooseValidationClient extends AddressDoctorClient {
	...
	public static final Logger log = Logger
			.getLogger(AddressLooseValidationClient.class);
	...
	public void cleanse(Map context, Map input, Map output) {
		...
		String server_url = cleanseProps
				.getProperty("LooselyValidatedAddressFinderRestProxy_URL");
		LooselyValidatedAddressFinderRestProxy proxy = new LooselyValidatedAddressFinderRestProxy(
				server_url);
		/* get map inputs */
