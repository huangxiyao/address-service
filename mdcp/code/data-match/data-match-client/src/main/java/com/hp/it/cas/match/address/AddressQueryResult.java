...
public class AddressQueryResult {
	...
	public class AddressData {
		 ...
		 * <d1>
		 * <dt>DEU_AGS</dt>
		 * <dd>The Amtliche Gemeindeschl�ssel (AGS) is a variable length code that uniquely identifies a locality in Germany. There may be more than one locality for a given AGS code.</dd>		 
