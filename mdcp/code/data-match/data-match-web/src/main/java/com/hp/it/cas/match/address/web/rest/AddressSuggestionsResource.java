...
public class AddressSuggestionsResource extends AbstractAddressResource {
	...
	private final AddressSuggestionsFinder finder;
	
	public AddressSuggestionsResource(AddressSuggestionsFinder finder, MessageInterpolator messageInterpolator, Locale[] locales){
		this.finder = finder;
